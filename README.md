...
<h2>🧑 Little facts about me</h2>
 ...
 <ul>
        <li><strong>🔭 I’m currently studying at</strong> <em>Universiti Teknologi Malaysia (UTM)</em>.</li>
        <li><strong>📫 I'm majoring in</strong> <em>Computer Science (Data Engineering)</em>.</li>
        <li><strong>💻 My focus areas:</strong> <em>Cloud Data Architecture (Azure) and Full-Stack Web Dev (React, Node.js)</em>.</li>
        <li>💬 Ask me about <strong>Data Pipelines, ETL Automation, and Web Development</strong>.</li>
        <li>🌟 Main stack: <strong>Python, SQL, JavaScript, PostgreSQL, Microsoft Azure</strong>.</li>
    </ul>
<hr>

## 🎓 Education & Certifications 

- **Universiti Teknologi Malaysia (UTM)** | Bachelor Degree in Computer Science (Data Engineering) | *Current CGPA: 3.99/4.00*
- **Certifications:** AWS Cloud Data Pipeline Builder, Microsoft Azure Data Fundamentals
